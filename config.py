...
forward_groups = ['测试群1','测试群2','有机生活一起享'] #'Python新手交流'  # 需要将消息转发的群，匹配模式同上

# 群分享监控
is_listen_sharing = False
listen_sharing_groups = '测试群1'  # 监控群分享，匹配模式同上
...
# 修改人: sunnyzhang
master_group_name = "测试群2"  # 机器人主人群的ID,请将"群ID"替换为实际的群组ID
...
master_group_forward_map = {
    "智能小助手 发广告": ["禾风 天然有机 景田1群", "禾风 天然有机 景田2群","多多严选.天然有机食材分享群"]
 #   "测试群3": ["测试群4", "测试群5","测试群1"]
}
